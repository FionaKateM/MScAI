...
In this case when approximated to 2 decimal places the confidence intervals are almost identical! 
...
```{r}
# confidence value in the mean - takes a default of 95% confidence
t.test(data$values)
```
